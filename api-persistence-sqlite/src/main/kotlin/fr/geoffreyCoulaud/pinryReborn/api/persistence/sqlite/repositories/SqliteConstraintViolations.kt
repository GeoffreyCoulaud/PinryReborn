 ...
 * that answer one with something other than the driver's exception: a domain error, or the row the
 * insert collided with.
 *
...
internal object SqliteConstraintViolations {
     ...
     * through this object. One discriminator and one rethrow, whatever a caller does with the
     * violation.
     */
